...
Java_fr_nourry_fnylib7z_FnyLib7z_00024Companion_stringFromJNIWriteTempFile(JNIEnv *env, jobject thiz,
                                                                           jstring path) {
    int response = 0;
...
Java_fr_nourry_fnylib7z_FnyLib7z_00024Companion_intFromJNIGetFDFileSize(JNIEnv *env, jobject thiz,
                                                                        jint fd) {
    // WORK !!
...
extern "C"
JNIEXPORT jint JNICALL
Java_fr_nourry_fnylib7z_FnyLib7z_00024Companion_intFromJNIGetUriFileSize(JNIEnv *env, jobject thiz,
                                                                         jstring path) {
    // DOESN'T WORK !!!
...
Java_fr_nourry_fnylib7z_FnyLib7z_00024Companion_get7zVersionInfo(JNIEnv *env, jobject thiz) {
