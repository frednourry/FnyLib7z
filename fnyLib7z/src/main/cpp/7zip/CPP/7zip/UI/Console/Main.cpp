...
static const char *kHelpString =
    ...
    "  -fny-stdout[{stdout file}]: write std output in this file  (ADDED by FNY)\n"
    "  -fny-stderr[{stdout file}]: write error output in this file  (ADDED by FNY)\n"
...
*/
  ...
  */
  ...
  else if (options.Command.IsFromUpdateGroup())
  {
    ...
    uo.IdFileDescriptor = options.IdFileDescriptor;             // FNY
    uo.OutFilename = options.OutFilename;                       // FNY
  ...
  if (options.Command.CommandType == NCommandType::kList && retCode == NExitCode::kSuccess) {
    // FNY - return the numbers of files
    return hresultMain;
  } else {
